            ...
            <div className="container-fluid">
                ...
                <div className="col-md-4 col-sm-6 col-xs-12 card mb-2 py-3">
                    ...
                    <div className="col-md-4 col-sm-6 col-xs-12 card mb-2 py-3 py-3">
                        <img src={p12} alt="" srcset="" className="img-fluid"  width="100%" style={{height:'300px'}} />
                    ...
                    <div className="col-md-4 col-sm-6 col-xs-12 card mb-2 py-3">
                        <a href="https://mimhakknai.github.io/Honda/"><img src={p2} alt="" srcset="" className="img-fluid"  width="100%" style={{height:'300px'}} /></a>
                    ...
                    <div className="col-md-4 col-sm-6 col-xs-12 card mb-2 py-3">
                        <a href="https://eloquent-hoover-2a0c49.netlify.app/"><img src={p5} alt="" srcset="" className="img-fluid" width="100%" style={{height:'300px'}} /></a>
                    ...
                    <div className="col-md-4 col-sm-6 col-xs-12 card mb-2 py-3">
                        <a href="https://sad-newton-7a46d0.netlify.app/"><img src={p6} alt="" srcset="" className="img-fluid"  width="100%" style={{height:'300px'}} /></a>
